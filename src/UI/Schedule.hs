...
import qualified Graphics.Vty as V (black, magenta, defAttr)
...
drawDate s =  withBorderStyle unicodeRounded . B.border . C.hCenter . padTopBottom 1 $ 
              hBox [str $ formatDate (day s)]

drawClear :: State -> T.Widget Widget
drawClear s =  withBorderStyle unicodeRounded . B.border . C.hCenter $ 
